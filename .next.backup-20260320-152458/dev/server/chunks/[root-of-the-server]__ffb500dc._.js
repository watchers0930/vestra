...
async function GET() {
    ...
    const [totalUsers, roleBreakdown, pendingVerifications, todayUsageRecords, totalAnalyses, totalAssets] = await Promise.all([
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.groupBy({
            by: [
                "role"
            ],
            _count: {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dailyUsage.findMany({
            where: {
                id: {
                    startsWith: `daily:`
                },
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].analysis.count(),
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].asset.count()
    ]);
    ...
    const usageRecords = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dailyUsage.findMany({
        where: {
            id: {
                startsWith: "daily:"
            },
    ...
    const dailyTrend = Object.entries(trendMap).map(([date, count])=>({
            date,
            count
        }));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ffb500dc._.js.map