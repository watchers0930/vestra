...
"[project]/app/api/admin/training-data/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    ...
    const item = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].trainingData.findUnique({
        where: {
            id
        }
    });
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...item,
        rawText: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crypto$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decryptPII"])(item.rawTextEncrypted),
...
async function PUT(req, { params }) {
    ...
    const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].trainingData.update({
        where: {
            id
        },
        data: updateData,
...
async function DELETE(_req, { params }) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].trainingData.delete({
        where: {
            id
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f50d0636._.js.map