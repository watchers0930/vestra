...
"[project]/lib/scholar.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function searchSemanticScholar(query, apiKey) {
    ...
    const papers = (json.data || []).map(// eslint-disable-next-line @typescript-eslint/no-explicit-any
    (p)=>({
            title: p.title || "",
...
// ─── RISS ───
async function searchRISS(query, apiKey) {
    const params = new URLSearchParams({
        query,
        apiKey,
        displayCount: "5"
...
// ─── KCI ───
async function searchKCI(query, apiKey) {
    const params = new URLSearchParams({
        key: apiKey,
        title: query,
        displayCount: "5"
...
async function searchScholarPapers(query) {
    const settings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getScholarSettings"])();
    const tasks = [];
    const activeSources = [];
    // Semantic Scholar: API 키 없이도 호출 가능 (rate limit 더 낮음)
    const semanticKey = settings[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCHOLAR_PROVIDERS"][0].apiKeyName];
    tasks.push(searchSemanticScholar(query, semanticKey || undefined).catch(()=>[]));
    activeSources.push("Semantic Scholar");
    // RISS: API 키 필수
    const rissKey = settings[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCHOLAR_PROVIDERS"][1].apiKeyName];
    if (rissKey) {
        tasks.push(searchRISS(query, rissKey).catch(()=>[]));
        activeSources.push("RISS");
    }
    // KCI: API 키 필수
    const kciKey = settings[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCHOLAR_PROVIDERS"][2].apiKeyName];
    if (kciKey) {
    ...
    return {
        papers: unique.slice(0, 10),
        sources: activeSources
    };
}
}),
"[project]/app/api/scholar/search/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scholar$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/scholar.ts [app-route] (ecmascript)");
;
;
;
async function POST(req) {
    ...
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scholar$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchScholarPapers"])(query);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__87a1c0d7._.js.map