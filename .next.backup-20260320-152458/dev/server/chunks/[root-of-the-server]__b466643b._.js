...
async function GET() {
    ...
    const [dbOAuth, dbPG, dbScholar] = await Promise.all([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOAuthSettings"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPGSettings"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getScholarSettings"])()
    ]);
    // OAuth 프로바이더
    const providers = {};
    ...
    // PG 프로바이더
    const pgProviders = {};
    for (const p of __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PG_PROVIDERS"]){
        ...
        pgProviders[p.provider] = {
            label: p.label,
            clientKey: hasDb ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["maskValue"])(dbKey) : hasEnv ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["maskValue"])(envKey) : "",
    ...
    // Scholar 프로바이더
    const scholarProviders = {};
    for (const p of __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCHOLAR_PROVIDERS"]){
        ...
        scholarProviders[p.provider] = {
            label: p.label,
            apiKey: hasDb ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["maskValue"])(dbKey) : hasEnv ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["maskValue"])(envKey) : "",
            configured: hasDb || hasEnv,
            source: hasDb ? "db" : hasEnv ? "env" : "none",
            baseUrl: p.baseUrl,
            description: p.description
...
async function PUT(req) {
    const csrfError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$csrf$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateOrigin"])(req);
    ...
    if (category === "scholar") {
        const { apiKey } = body;
        const config = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SCHOLAR_PROVIDERS"].find((p)=>p.provider === provider);
        if (!config) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "지원하지 않는 논문검색 서비스"
            }, {
                status: 400
            });
        }
        if (!apiKey) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteScholarSetting"])(config.apiKeyName);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `${config.label} 설정이 초기화되었습니다.`
            });
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setScholarSetting"])(config.apiKeyName, apiKey);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: `${config.label} API 키가 저장되었습니다.`
        });
    }
    // PG 설정
    if (category === "pg") {
        const { clientKey, secretKey } = body;
        const config = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PG_PROVIDERS"].find((p)=>p.provider === provider);
        if (!config) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "지원하지 않는 PG사"
            }, {
        ...
        if (!clientKey && !secretKey) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deletePGSetting"])(config.clientKeyName);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deletePGSetting"])(config.secretKeyName);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `${config.label} 설정이 초기화되었습니다.`
            });
        }
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setPGSetting"])(config.clientKeyName, clientKey);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$system$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setPGSetting"])(config.secretKeyName, secretKey);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: `${config.label} 결제 설정이 저장되었습니다.`
        });
    }
    // OAuth 설정 (기존)
    ...
    // 감사 로그: 설정 변경
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audit$2d$log$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAuditWithRequest"])({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b466643b._.js.map