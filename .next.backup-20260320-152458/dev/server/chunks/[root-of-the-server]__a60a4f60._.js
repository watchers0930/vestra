...
"[project]/app/api/admin/vocabulary/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    if (search) where.term = {
        contains: search
    };
    const [items, total] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].domainVocabulary.findMany({
            where,
            orderBy: [
                {
                    category: "asc"
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].domainVocabulary.count({
            where
        })
    ]);
    // 카테고리별 통계
    const [registryRight, legalAction, structure, financeTax, totalCount] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].domainVocabulary.count({
            where: {
...
async function POST(req) {
    ...
    // 중복 체크 후 upsert
    const vocab = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].domainVocabulary.upsert({
        where: {
            term: term.trim()
        },
        update: {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(vocab);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__a60a4f60._.js.map