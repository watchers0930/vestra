...
"[project]/components/prediction/LeafletMap.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getFallbackCoords(address) {
...
/** Nominatim API 단건 조회 */ async function nominatimSearch(query) {
    try {
...
/** 주소 → 좌표 변환 (단계적 검색: 전체 → 시/구/동 → 시/구) */ async function geocodeAddress(address) {
    // 1차: 전체 주소로 검색
    const full = await nominatimSearch(address);
    if (full) return full;
    // 주소에서 핵심 지명 추출 (숫자/면적/아파트명 등 제거)
    const cleaned = address.replace(/\d+㎡/g, "").replace(/\d+평/g, "").replace(/\d+호/g, "").replace(/\d+동/g, (m)=>/[가-힣]동/.test(m) ? m : "").trim();
    // 2차: 정제된 주소로 검색
    if (cleaned !== address) {
...
function LeafletMap({ address }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LeafletMap.useEffect": ()=>{
            ...
            function createMap(coords, zoom) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$leaflet$2f$dist$2f$leaflet$2d$src$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].marker(coords, {
                    icon
                }).addTo(map).bindPopup(`<b>${address}</b>`).openPopup();
                mapInstanceRef.current = map;
                setTimeout({
                    "LeafletMap.useEffect.createMap": ()=>map.invalidateSize()
                }["LeafletMap.useEffect.createMap"], 100);
            }
            // Geocoding 시도 → 실패 시 폴백 좌표 사용
            geocodeAddress(address).then({
                "LeafletMap.useEffect": (coords)=>{
                    if (coords) {
                        createMap(coords, 16);
                    } else {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$common$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/components/prediction/LeafletMap.tsx",
            lineNumber: 209,
            columnNumber: 7
        }, this)
    }, void 0, false, {
...
_s(LeafletMap, "HGOaeZ8o3YxgkGMPZTdc6qMIX/A=");
_c = LeafletMap;
var _c;
...
"[project]/components/prediction/LeafletMap.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/components/prediction/LeafletMap.tsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=components_prediction_LeafletMap_tsx_579288d8._.js.map