...
export const RIGHTS_ANALYSIS_OPINION_PROMPT = `당신은 대한민국 부동산 권리분석 전문가입니다.
...
// ─── V-Score 자연어 설명 생성 프롬프트 ───

export const V_SCORE_EXPLANATION_PROMPT = `당신은 VESTRA V-Score 분석 결과를 일반 사용자에게 설명하는 전문가입니다.
...
export const FRAUD_RISK_EXPLANATION_PROMPT = `당신은 VESTRA 전세사기 위험 분석 결과를 설명하는 전문가입니다.
