/**
 * 계약서 조항 리스크 규칙 DB + 누락 조항 체크리스트 + 상호작용 분석
 *
 * @module lib/contract/clause-rules
 */
...
export const REQUIRED_CLAUSES: RequiredClauseCheck[] = [
  {
...
// ─── 조항 상호작용 규칙 (특허 청구항: 교차 위험 분석) ───

export const CLAUSE_INTERACTION_RULES: ClauseInteractionRule[] = [
  {
 ...
 * - 조항 간 불균형(임대인 유리 편향)
 */
export function analyzeClauseInteractions(
