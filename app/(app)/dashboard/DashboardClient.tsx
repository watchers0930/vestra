...
import { Shield, Building2, Banknote, AlertTriangle, ClipboardList } from "lucide-react";
...
/**
 * 대시보드 콘텐츠(사업자: RENTAL_BIZ / BUSINESS 전용).
 * 역할 분배(허브)는 서버 컴포넌트 page.tsx에서 redirect로 처리하므로
 * 이 클라이언트 컴포넌트는 순수 대시보드 렌더만 담당한다(구 UI 깜빡임 제거).
 */
