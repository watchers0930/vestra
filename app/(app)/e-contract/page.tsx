...
const STEPS = ["계약유형", "계약정보", "당사자·서명", "확인·출력"];
  ...
  return (
    <AuthGuard featureName="가계약서">
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        <CategoryHero badge="📝 가계약서" title="가계약서 작성" description="주요 조건을 담은 가계약서를 만들어 출력하고, 오프라인에서 본계약으로 확정하세요." />

        {step !== "done" && <StepIndicator steps={STEPS} currentStep={stepIdx} />}
