          ...
          {safety && (
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 12 }}>
              {safety.jeonseRatio != null && (() => {
                ...
                return (
                  <div style={{ flex: 1, minWidth: 110, borderRadius: 12, padding: "12px 14px", background: safe ? "rgba(var(--accent-positive-rgb), 0.08)" : warn ? "rgba(var(--accent-warning-rgb), 0.08)" : "rgba(255,59,48,0.08)" }}>
