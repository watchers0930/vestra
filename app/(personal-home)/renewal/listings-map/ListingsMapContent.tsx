...
export default function ListingsMapContent() {
  ...
  const selectOption = (key: FilterKey, value: string) => {
    ...
    const displayLabel = isDefault ? FILTER_DEFAULTS[key] : value;
    setFilterLabels((prev) => ({ ...prev, [key]: displayLabel }));
        ...
        <div className={`${s.mapDetailPanel} ${detailOpen ? s.open : ""}`}>
          ...
          <div className={s.detailBody}>
            ...
            <div style={{ marginBottom: "14px" }}>
              <span className={s.detailTrustBadge}>VESTRA 안심인증 매물</span>
            </div>
