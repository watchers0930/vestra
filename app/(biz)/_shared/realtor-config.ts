...
export const REALTOR_QUICK: QuickMenuItem[] = [
  { href: REALTOR_ROUTES.agent, label: "중개관리", sub: "CRM · 손님매칭", icon: "🗂️", hot: true },
  { href: REALTOR_ROUTES.eContract, label: "전자계약", sub: "가계약서 작성", icon: "✍️" },
  { href: REALTOR_ROUTES.listings, label: "매물 목록", sub: "등록·수정", icon: "🏢" },
  { href: REALTOR_ROUTES.rights, label: "권리분석", sub: "등기부 진단", icon: "🔍" },
  { href: REALTOR_ROUTES.priceMap, label: "시세지도", sub: "실거래 조회", icon: "🗺️" },
];
