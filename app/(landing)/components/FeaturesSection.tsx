...
const FEATURES = [
  {
    tier: "tt", label: "Tenant Protection", title: "전세 보호", href: "/jeonse",
  ...
  {
    tier: "", label: "Registry Guard", title: "AI 등기부 변동위험감지", href: "/monitoring",
  ...
  {
    tier: "tt", label: "Rights Analysis", title: "권리 분석", href: "/rights",
  ...
  {
    tier: "", label: "Contract Review", title: "계약서 AI 검토", href: "/contract",
  ...
  {
    tier: "tf", label: "Tax Simulation", title: "세무 시뮬레이션", href: "/tax",
  ...
  {
    tier: "", label: "AI Assistant", title: "AI 어시스턴트", href: "/assistant",
