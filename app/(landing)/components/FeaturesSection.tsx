...
const FEATURES = [
  {
    tier: "tt", label: "Tenant Protection", title: "전세 보호", href: "/renewal/jeonse",
  ...
  {
    tier: "", label: "Registry Guard", title: "AI 등기부 변동위험감지", href: "/renewal/monitoring",
  ...
  {
    tier: "tt", label: "Rights Analysis", title: "권리 분석", href: "/renewal/rights",
  ...
  {
    tier: "tt", label: "Market Prediction", title: "시세 전망", href: "/prediction",
  ...
  {
    tier: "", label: "Contract Review", title: "계약서 AI 검토", href: "/renewal/contract",
  ...
  {
    tier: "tf", label: "Tax Simulation", title: "세무 시뮬레이션", href: "/renewal/tax",
  ...
  {
    tier: "", label: "Business Analysis", title: "사업성 분석", href: "/feasibility",
  ...
  {
    tier: "", label: "AI Assistant", title: "AI 어시스턴트", href: "/renewal/assistant",
        ...
        <div className="lnd-feat-grid">
          {FEATURES.map((f, i) => (
            <ScrollReveal key={f.title} delay={(i % 3) * 0.06}>
              <Link href={f.href} className="lnd-feat-card">
                {f.tier && (
