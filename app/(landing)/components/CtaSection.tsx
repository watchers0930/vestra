...
export function CtaSection() {
  return (
    <section className="py-40 bg-[#00042a] text-white relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-12 text-center relative z-10 cta-section">
        <span className="landing-section-label text-white/40 mb-8 block">Get Started</span>
        <h2 className="text-5xl lg:text-6xl font-extrabold mb-8 tracking-tight cta-title">
          지금 바로<br />시작하세요
        </h2>
